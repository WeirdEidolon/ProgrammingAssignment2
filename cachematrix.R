...
## return the inverse of a CacheMatrix object. if the inverse has not been calculated
## do so and cache it on the CacheMatrix object. otherwise return the cached inverse.
